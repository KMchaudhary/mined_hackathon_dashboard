  ...
  return (
    <>
        <div className="flex flex-col bg-slate-900 sm:flex-row min-h-screen">
            ...
            {/* Navbar */}
            <div className="nav-bar bg-slate-800 sticky top-0 sm:relative">
            <div className="sticky top-0">
                ...
                <div className="font-bold px-4 py-2 text-white flex flex-row justify-between">
                    ...
                    <button className="nav-item-red text-red-500 sm:hidden">Logout</button>
                </div>
